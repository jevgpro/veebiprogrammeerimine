<<?php
	...
	$monthNamesET = ["jaanuar", "vebruar", "märts", "aprill", "mai", "juuni", "juuli", "august", "september", "oktoober", "november", "detsember"];
	echo $monthNamesET[0];
...
<body bgcolor="#808080" text="#FA8E47">
	...
	<?php
		echo "<p>Täna on " .$weekDayNamesET[$weekDayNow - 1] .", " .$todayDay .". " .$monthNamesET[$monthNow - 1] .", " .$todayYear ."</p> \n";
